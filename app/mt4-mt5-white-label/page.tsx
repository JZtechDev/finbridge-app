        ...
        <div className="container flex justify-between items-center pb-10">
          <div className="lg:max-w-[50%] m-auto flex flex-col gap-[25px]">
            ...
            <p className="text-body opacity-50 font-medium ">
              {`Focus on Clients, We Handle the Launch: Your Complete MT4/MT5  brokerage with a branded platform and FINBRIDGE’s Liquidity Hub – all set up in just 7days.`}
            </p>
        ...
        <div className="container flex justify-center">
          <div className="max-w-[700px]">
            <h4 className="text-h4 text-transparent leading-tight bg-gradient-to-t from-[#B3B3B3] to-white bg-clip-text font-medium text-center mb-5">
              {`Get Started Today: Launch Your MT4/MT5 Brokerage`}
            </h4>

            <p className="text-body opacity-50 font-medium text-center">
              {`FINBRIDGE’s MT4/MT5 White-Label services in cooperation with Itexsys provides a quick and easy way to start a financial services company. This cost-effective solution allows brokers to significantly save on the set-up and running overheads. White Label clients benefit from a fully managed technological solution at a fraction of the cost of running a full-scale financial brokerage with a 24/7 Technical Support.`}
            </p>
          </div>
        </div>
        ...
        <div className="container grid lg:grid-cols-3 md:grid-cols-2 gap-[5px] py-16 ">
          <div className="bg-[#040A1466] border border-[#B7D2FF26] p-[10px] rounded-[20px] flex flex-col gap-[15px]">
            <div className="p-[15px]">
              ...
              <p className="text-body opacity-50 font-medium flex gap-2">
                ...
                Multiple Manager logins with role and access level assignment
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
          ...
          <div className="bg-[#040A1466] border border-[#B7D2FF26] p-[10px] rounded-[20px] flex flex-col gap-[15px]">
            <div className="p-[15px]">
              ...
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                24/7 Level 2 Technical Support
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Real time monitoring and automatic mitigation
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Live notification system and proactive troubleshooting
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Onsite mitigation in case of hardware failure
              </p>
            </div>
          </div>
          <div className="bg-[#040A1466] border border-[#B7D2FF26] p-[10px] rounded-[20px] flex flex-col gap-[15px]">
            <div className="p-[15px]">
              ...
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Cross-connectivity between MT4/MT5 Severs, Your Bourse Platform
                and Liquidity Providers
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Highest level security and DDoS protection
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Full redundancy with real-time hot backups and automatic
                failover
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#040A1466] border border-[#B7D2FF26] p-[10px] rounded-[20px] flex flex-col gap-[15px]">
            <div className="p-[15px]">
              ...
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Choose your own Liquidity Providers
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Cross-connects to 30+ Liquidity Providers (see the full list of
                Liquidity Providers)
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Relationship management and liquidity analytics
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Seamless one-click integration with all Liquidity Providers
              </p>
            </div>
          </div>
        </div>
