        ...
        <div className="container flex justify-between items-center pb-10">
          <div className="lg:max-w-[50%] m-auto flex flex-col gap-[25px]">
            ...
            <p className="text-body opacity-50 font-medium ">
              {`Experience the ultimate combination – ultra-low latency hosting,
              industry-leading security, and expert administration for your
              MT4/MT5 platform. All at a price that empowers your business.`}
            </p>
        ...
        <div className="container flex justify-center">
          <div className="max-w-[700px]">
            <h4 className="text-h4 text-transparent leading-tight bg-gradient-to-t from-[#B3B3B3] to-white bg-clip-text font-medium text-center mb-5">
              {`Benefit from the combined power of FINBRIDGE’s expertise and
              Equinix's world-class data center network.`}
            </h4>

            <p className="text-body opacity-50 font-medium text-center">
              Experience the difference of premium MT4/MT5 hosting. FINBRIDGE
              takes full responsibility for your servers, guaranteeing seamless
              operation and freeing you to focus on core business activities.
              Hosting is available in all Equinix data centers across the globe
              along with cross-connection between MT4/MT5, FINBRIDGE Platform,
        ...
        <div className="container grid lg:grid-cols-3 md:grid-cols-2 gap-[5px] py-16 ">
          ...
          <div className="bg-[#040A1466] border border-[#B7D2FF26] p-[10px] rounded-[20px] flex flex-col gap-[15px]">
            <div className="p-[15px]">
              ...
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Watchdog servers located in a dedicated failover facility
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                Ultra-low latency network between all Data Centres
              </p>
              <p className="text-body opacity-50 font-medium flex gap-2">
                <Check size={16} className="mt-1 !min-w-4 !min-h-4" />
                DDoS Protection with up to 300Gbps of DDoS traffic
              </p>
            </div>
          </div>
        </div>
